...
/**
 * Class CmsPluginFunctionsConcrete5
 */
class CmsPluginFunctionsConcrete5
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback" : "//wordpress.org/support/plugin/cms2cms-concrete5-to-wp-migration/reviews",
    ...
    {
        $cms2cms_concrete5_access_login = get_option('cms2cms-concrete5-login');
        $cms2cms_concrete5_access_key   = get_option('cms2cms-concrete5-key');

        return array(
            'email'     => $cms2cms_concrete5_access_login,
            'accessKey' => $cms2cms_concrete5_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_concrete5_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-concrete5-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-concrete5-key', $key);

            delete_option('cms2cms-concrete5-login');
            add_option('cms2cms-concrete5-login', $login);

            delete_option('cms2cms-concrete5-depth');
            add_option('cms2cms-concrete5-depth', $bridge_depth);
    ...
    {
        return $this->__('Concrete5', 'cms2cms-concrete5-migration');
    }
    ...
    {
        return $this->__('WordPress', 'cms2cms-concrete5-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-concrete5-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-concrete5-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
...
;
    ...
    public function logOut()
    {
        if (isset($_REQUEST['_wpnonce'])) {
            ...
            if ($this->verifyFormTempKey($nonce, 'cms2cms_concrete5_logout')
                && $_POST['cms2cms_concrete5_logout'] == 1
            ) {
                $this->clearOptions();
            }
        }
