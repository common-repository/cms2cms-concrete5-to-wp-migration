...
/*
    ...
    Description: Concrete5 to WordPress automated data migration plugin. Convert Concrete5 to WordPress easily and fast.
    Version: 3.7.0
    Author: CMS2CMS
...
define( 'CMS2CMS_CONCRETE5_VERSION', '3.7.0' );
